...
class imgUpldr {
	...
	private $_width = 147; // Ancho máximo por defecto
	private $_height = 159; // Alto máximo por defecto
	private $_size = 2000000; // Peso máximo. MAX_FILE_SIZE sobrescribe este valor
